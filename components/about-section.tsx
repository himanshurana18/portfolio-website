...
const timeline = [
  {
    ...
    status: "ongoing",
    description:
      "Specializing in Data Science with focus on modern web technologies and real-time systems.",
  },
  {
    year: "2025",
    ...
    status: "completed",
    description:
      "Led team to Top 10 ranking from college. Participated twice, showcasing problem-solving skills.",
  },
  {
    year: "2025",
    ...
    status: "ongoing",
    description:
      "Delivered photographer portfolio with 98 Lighthouse score and 35% increase in client inquiries.",
  },
  {
    year: "2025",
    ...
    status: "completed",
    description:
      "Demonstrated exceptional problem-solving and teamwork in competitive programming environment.",
  },
  {
    year: "2020",
    ...
    status: "completed",
    description:
      "CBSE curriculum with strong foundation in mathematics and computer science.",
  },
];
...
export function AboutSection() {
  ...
  const downloadResume = () => {
    ...
    window.open(
      "https://drive.google.com/drive/folders/1qmkeRCaictFgYioj-uFQ1y8JxKKNmWVf?usp=drive_link",
      "_blank"
    );
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            From curiosity to building to shipping — my journey in creating
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  I'm Himanshu, a full-stack developer who loves turning complex
                  ideas into smooth, interactive web apps. My journey started
                  with curiosity about how things work on the web, evolved into
                  building solutions for real problems, and now focuses on
                  shipping products that feel alive.
                </p>
                <p>
                  I specialize in real-time experiences, modern stacks, and
                  clean, maintainable code. When I'm not shipping features, I'm
                  exploring new animations, refining UX, or competing in
                  hackathons where I've consistently ranked in the top
                  performers.
                </p>
                <p>
                  Currently pursuing B.Tech in Computer Science with Data
                  Science specialization while actively freelancing and building
